...
export default function AdminNotifications() {
    ...
    return (_jsxs(AdminLayout, { title: "Notifications Push", children: [_jsx("div", { className: "mb-6", children: _jsx("p", { className: "text-sm text-gray-500", "data-testid": "text-admin-notif-title", children: "Envoyez des notifications ciblees a vos clients" }) }), _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [_jsx("div", { className: "lg:col-span-2 space-y-4", children: _jsxs("div", { className: "bg-white rounded-xl border border-gray-100 p-5", children: [_jsxs("h3", { className: "font-bold text-sm text-gray-900 mb-4 flex items-center gap-2", children: [_jsx(Megaphone, { size: 16, className: "text-red-500" }), "Composer une notification"] }), _jsxs("div", { className: "mb-4", children: [_jsx("p", { className: "text-xs font-semibold text-gray-500 uppercase mb-2", children: "Modeles rapides" }), _jsx("div", { className: "flex flex-wrap gap-2", children: templates.map((t, i) => (_jsx("button", { onClick: () => { setTitle(t.title); setMessage(t.message); setNotifType(t.type); }, "data-testid": `template-${i}`, className: "px-3 py-1.5 bg-gray-50 rounded-lg text-xs font-medium text-gray-600 hover:bg-red-50 hover:text-red-600 border border-gray-200 transition-all", children: t.title }, i))) })] }), _jsxs("div", { className: "space-y-3", children: [_jsxs("div", { children: [_jsx("label", { className: "text-xs font-semibold text-gray-500 uppercase mb-1 block", children: "Type" }), _jsx("div", { className: "flex gap-2", children: [
                                                        { key: "promo", label: "Promo", icon: Target },
                                                        { key: "info", label: "Info", icon: Bell },
                                                        { key: "service", label: "Service", icon: Zap },
                                                    ].map(t => (_jsxs("button", { type: "button", onClick: () => setNotifType(t.key), className: `flex-1 py-2 rounded-lg text-sm font-semibold flex items-center justify-center gap-1.5 ${notifType === t.key ? "bg-red-600 text-white" : "bg-gray-50 text-gray-600 border border-gray-200"}`, children: [_jsx(t.icon, { size: 14 }), " ", t.label] }, t.key))) })] }), _jsxs("div", { children: [_jsx("label", { className: "text-xs font-semibold text-gray-500 uppercase mb-1 block", children: "Titre" }), _jsx("input", { type: "text", value: title, onChange: e => setTitle(e.target.value), placeholder: "Titre de la notification", "data-testid": "input-notif-title", className: "w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-red-500 focus:outline-none" })] }), _jsxs("div", { children: [_jsx("label", { className: "text-xs font-semibold text-gray-500 uppercase mb-1 block", children: "Message" }), _jsx("textarea", { value: message, onChange: e => setMessage(e.target.value), placeholder: "Contenu de la notification...", "data-testid": "input-notif-message", className: "w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm h-28 resize-none focus:ring-2 focus:ring-red-500 focus:outline-none" })] })] }), sent ? (_jsxs("div", { className: "mt-4 bg-green-50 border border-green-200 rounded-xl p-4 flex items-center gap-3", "data-testid": "notif-sent-success", children: [_jsx(CheckCircle, { size: 24, className: "text-green-600" }), _jsxs("div", { children: [_jsx("p", { className: "font-bold text-sm text-green-800", children: "Notification envoyee !" }), _jsxs("p", { className: "text-xs text-green-600", children: [sentCount, " client", sentCount !== 1 ? "s" : "", " notifie", sentCount !== 1 ? "s" : ""] })] })] })) : (_jsxs("button", { onClick: handleSend, disabled: broadcastMutation.isPending, "data-testid": "button-send-broadcast", className: "mt-4 w-full bg-red-600 text-white py-3 rounded-xl text-sm font-bold hover:bg-red-700 disabled:opacity-50 shadow-lg shadow-red-200 flex items-center justify-center gap-2", children: [broadcastMutation.isPending ? _jsx(Loader2, { size: 16, className: "animate-spin" }) : _jsx(Send, { size: 16 }), broadcastMutation.isPending ? "Envoi en cours..." : "Envoyer la notification"] }))] }) }), _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "bg-white rounded-xl border border-gray-100 p-5", children: [_jsxs("h3", { className: "font-bold text-sm text-gray-900 mb-4 flex items-center gap-2", children: [_jsx(Target, { size: 16, className: "text-red-500" }), "Segment cible"] }), _jsx("div", { className: "space-y-2", children: Object.entries(segments).map(([key, seg]) => {
                                            const Icon = segmentIcons[key] || Users;
                                            const gradient = segmentColors[key] || "from-gray-500 to-gray-600";
                                            return (_jsxs("button", { onClick: () => setTargetSegment(key), "data-testid": `segment-${key}`, className: `w-full p-3 rounded-xl flex items-center gap-3 transition-all text-left ${targetSegment === key ? "bg-red-50 border-2 border-red-500" : "bg-gray-50 border-2 border-transparent hover:bg-gray-100"}`, children: [_jsx("div", { className: `w-9 h-9 bg-gradient-to-br ${gradient} rounded-lg flex items-center justify-center`, children: _jsx(Icon, { size: 16, className: "text-white" }) }), _jsxs("div", { className: "flex-1", children: [_jsx("p", { className: "text-xs font-bold text-gray-900", children: seg.label }), _jsxs("p", { className: "text-[10px] text-gray-500", children: [seg.count, " client", seg.count !== 1 ? "s" : ""] })] }), targetSegment === key && (_jsx("div", { className: "w-4 h-4 bg-red-600 rounded-full flex items-center justify-center", children: _jsx(CheckCircle, { size: 10, className: "text-white" }) }))] }, key));
