...
function ElapsedTime({ createdAt }) {
    ...
    return (_jsxs("span", { className: `text-[10px] font-semibold ${isUrgent ? "text-red-600" : "text-gray-500 dark:text-gray-400"}`, "data-testid": "elapsed-time", children: [_jsx(Clock, { size: 9, className: "inline mr-0.5" }), elapsed, isUrgent && _jsx("span", { className: "ml-1 px-1 py-0.5 bg-red-600 text-white text-[8px] font-bold rounded", children: "URGENT" })] }));
}
export default function AdminDrivers() {
        ...
        switch (dispatchTab) {
            ...
            case "completed":
                return (_jsxs("div", { children: [_jsx("div", { className: "flex items-center justify-between mb-4 gap-2 flex-wrap", children: _jsxs("h2", { className: "text-lg font-bold text-gray-900 dark:text-white", "data-testid": "tab-title-completed", children: ["Commandes completees (", completedOrders.length, ")"] }) }), completedOrders.length === 0 ? (_jsxs("div", { className: "text-center py-16 text-gray-400", children: [_jsx(CheckCircle2, { size: 36, className: "mx-auto mb-3 opacity-20" }), _jsx("p", { className: "text-sm font-medium", children: "Aucune commande livree" })] })) : (_jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3", children: completedOrders.map(order => {
                                ...
                                return (_jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-4", "data-testid": `completed-order-${order.id}`, children: [_jsxs("div", { className: "flex items-center justify-between gap-2 flex-wrap", children: [_jsx("span", { className: "font-bold text-sm text-gray-900 dark:text-white", children: order.orderNumber }), isOnTime === true && (_jsx("span", { className: "text-[8px] font-bold px-2 py-0.5 rounded-md bg-green-100 text-green-700", "data-testid": `ontime-badge-${order.id}`, children: "A l'heure" })), isOnTime === false && (_jsx("span", { className: "text-[8px] font-bold px-2 py-0.5 rounded-md bg-red-100 text-red-700", "data-testid": `late-badge-${order.id}`, children: "En retard" })), isOnTime === null && (_jsx("span", { className: "text-[8px] font-bold px-2 py-0.5 rounded-md bg-gray-100 text-gray-500 dark:text-gray-400", children: "--" }))] }), _jsx("p", { className: "text-xs text-gray-600 mt-1.5", children: getRestaurantName(order.restaurantId) }), _jsxs("p", { className: "text-[10px] text-gray-500 mt-1 truncate", children: [_jsx(MapPin, { size: 9, className: "inline mr-0.5" }), order.deliveryAddress] }), _jsxs("div", { className: "flex items-center justify-between mt-2 gap-2 flex-wrap", children: [_jsx("span", { className: "text-xs font-bold text-red-600", children: formatPrice(order.total) }), driver && _jsxs("span", { className: "text-[10px] text-gray-500 dark:text-gray-400", children: [_jsx(Truck, { size: 9, className: "inline mr-0.5" }), driver.name] })] }), order.updatedAt && _jsx("p", { className: "text-[9px] text-gray-400 mt-1.5", children: formatDate(order.updatedAt) })] }, order.id));
                            }) }))] }));
            case "free":
                return (_jsxs("div", { children: [_jsx("div", { className: "flex items-center justify-between mb-4 gap-2 flex-wrap", children: _jsxs("h2", { className: "text-lg font-bold text-gray-900 dark:text-white", "data-testid": "tab-title-free", children: ["Livreurs disponibles (", freeDrivers.length, ")"] }) }), freeDrivers.length === 0 ? (_jsxs("div", { className: "text-center py-16 text-gray-400", children: [_jsx(Truck, { size: 36, className: "mx-auto mb-3 opacity-20" }), _jsx("p", { className: "text-sm font-medium", children: "Aucun livreur disponible" })] })) : (_jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3", children: freeDrivers.map((d) => renderDriverCard(d, false)) }))] }));
            case "busy":
                return (_jsxs("div", { children: [_jsx("div", { className: "flex items-center justify-between mb-4 gap-2 flex-wrap", children: _jsxs("h2", { className: "text-lg font-bold text-gray-900 dark:text-white", "data-testid": "tab-title-busy", children: ["Livreurs occupes (", busyDrivers.length, ")"] }) }), busyDrivers.length === 0 ? (_jsxs("div", { className: "text-center py-16 text-gray-400", children: [_jsx(Truck, { size: 36, className: "mx-auto mb-3 opacity-20" }), _jsx("p", { className: "text-sm font-medium", children: "Aucun livreur occupe" })] })) : (_jsx("div", { className: "space-y-3", children: busyDrivers.map((d) => {
                                const active = getDriverActiveOrders(d.id);
                                const todayCount = getDriverTodayDeliveries(d.id);
                                const isExpanded = expandedBusyDriver === d.id;
                                return (_jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden", "data-testid": `busy-driver-card-${d.id}`, children: [_jsxs("button", { onClick: () => setExpandedBusyDriver(isExpanded ? null : d.id), "data-testid": `toggle-busy-driver-${d.id}`, className: "w-full px-4 py-3 flex items-center gap-3 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-left", children: [_jsx("div", { className: `w-11 h-11 rounded-xl flex items-center justify-center bg-orange-100 shrink-0`, children: _jsx(Truck, { size: 18, className: "text-orange-600" }) }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [_jsx("p", { className: "font-bold text-sm text-gray-900 truncate", children: d.name }), _jsxs("span", { className: "text-[8px] font-bold px-1.5 py-0.5 rounded-full bg-orange-100 text-orange-700", children: ["(", active.length, " commandes)"] })] }), _jsxs("div", { className: "flex items-center gap-3 mt-0.5 flex-wrap", children: [_jsxs("span", { className: "text-[10px] text-gray-500 dark:text-gray-400", children: [_jsx(Phone, { size: 9, className: "inline mr-0.5" }), d.phone] }), _jsx("span", { className: "text-[10px] text-gray-500 capitalize", children: d.vehicleType || "Moto" }), _jsxs("span", { className: "text-[10px] text-gray-400", children: [todayCount, " livr. aujourd'hui"] })] })] }), isExpanded ? _jsx(ChevronUp, { size: 16, className: "text-gray-400 shrink-0" }) : _jsx(ChevronDown, { size: 16, className: "text-gray-400 shrink-0" })] }), isExpanded && (_jsx("div", { className: "px-4 pb-3 border-t border-gray-100 dark:border-gray-800 pt-3 space-y-2", children: active.map(order => (_jsxs("div", { className: "bg-gray-50 rounded-xl p-3 border border-gray-100 dark:border-gray-800", "data-testid": `busy-driver-order-${order.id}`, children: [_jsxs("div", { className: "flex items-center justify-between gap-2 flex-wrap", children: [_jsx("span", { className: "font-bold text-xs text-gray-900 dark:text-white", children: order.orderNumber }), _jsx("span", { className: `text-[8px] font-bold px-1.5 py-0.5 rounded-md ${statusColors[order.status]}`, children: statusLabels[order.status] })] }), _jsx("p", { className: "text-[10px] text-gray-600 mt-1", children: getRestaurantName(order.restaurantId) }), _jsxs("p", { className: "text-[9px] text-gray-500 mt-0.5 truncate", children: [_jsx(MapPin, { size: 8, className: "inline mr-0.5" }), order.deliveryAddress] }), _jsxs("div", { className: "flex items-center justify-between mt-1.5 gap-2 flex-wrap", children: [_jsx("span", { className: "text-[10px] font-bold text-red-600", children: formatPrice(order.total) }), order.estimatedDelivery && _jsx(CountdownTimer, { estimatedDelivery: order.estimatedDelivery, compact: true })] })] }, order.id))) }))] }, d.id));
                            }) }))] }));
            case "offline":
                return (_jsxs("div", { children: [_jsx("div", { className: "flex items-center justify-between mb-4 gap-2 flex-wrap", children: _jsxs("h2", { className: "text-lg font-bold text-gray-900 dark:text-white", "data-testid": "tab-title-offline", children: ["Livreurs hors ligne (", offlineDrivers.length, ")"] }) }), offlineDrivers.length === 0 ? (_jsxs("div", { className: "text-center py-16 text-gray-400", children: [_jsx(Truck, { size: 36, className: "mx-auto mb-3 opacity-20" }), _jsx("p", { className: "text-sm font-medium", children: "Tous les livreurs sont en ligne" })] })) : (_jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3", children: offlineDrivers.map((d) => renderDriverCard(d, false)) }))] }));
            default:
                return null;
        }
    };
    return (_jsxs(AdminLayout, { title: "Gestion des livreurs", children: [_jsx("div", { className: "mb-4 overflow-x-auto -mx-2 px-2", children: _jsx("div", { className: "flex gap-1.5 min-w-max", children: dispatchTabs.map(tab => (_jsxs("button", { onClick: () => setDispatchTab(tab.key), "data-testid": `dispatch-tab-${tab.key}`, className: `px-4 py-2.5 rounded-xl text-xs font-semibold transition-all whitespace-nowrap flex items-center gap-1.5 ${dispatchTab === tab.key
                            ...
                            : "bg-white text-gray-600 border border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800"}`, children: [tab.label, _jsx("span", { className: `text-[10px] px-1.5 py-0.5 rounded-full font-bold ${dispatchTab === tab.key ? "bg-white/20 text-white" : "bg-gray-100 text-gray-500 dark:text-gray-400"}`, children: tab.count })] }, tab.key))) }) }), dispatchTab !== "gestion" ? (renderDispatchContent()) : (_jsxs(_Fragment, { children: [_jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 mb-4", children: [
                            ...
                            { key: "map", label: "Carte", icon: Navigation },
                                        ...
                                        ].map(f => (_jsxs("div", { children: [_jsx("label", { className: "text-[10px] font-semibold text-gray-500 mb-1 block", children: f.label }), _jsx("input", { type: f.type, value: form[f.key], onChange: e => setForm({ ...form, [f.key]: e.target.value }), "data-testid": f.testid, className: "w-full px-3 py-2.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-sm dark:text-white focus:ring-2 focus:ring-red-500 focus:outline-none" })] }, f.key))), _jsxs("div", { children: [_jsx("label", { className: "text-[10px] font-semibold text-gray-500 mb-1 block", children: "Vehicule" }), _jsxs("select", { value: form.vehicleType, onChange: e => setForm({ ...form, vehicleType: e.target.value }), "data-testid": "select-vehicle-type", className: "w-full px-3 py-2.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-sm dark:text-white", children: [_jsx("option", { value: "moto", children: "Moto" }), _jsx("option", { value: "velo", children: "Velo" }), _jsx("option", { value: "voiture", children: "Voiture" }), _jsx("option", { value: "scooter", children: "Scooter" })] })] }), _jsxs("div", { children: [_jsx("label", { className: "text-[10px] font-semibold text-gray-500 mb-1 block", children: "Commission (%)" }), _jsx("input", { type: "number", value: form.commissionRate, onChange: e => setForm({ ...form, commissionRate: Number(e.target.value) }), "data-testid": "input-commission", className: "w-full px-3 py-2.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-sm dark:text-white focus:ring-2 focus:ring-red-500 focus:outline-none" })] })] }), _jsxs("div", { className: "flex gap-2 mt-5", children: [_jsx("button", { onClick: handleSave, "data-testid": "button-save-driver", className: "flex-1 bg-red-600 text-white py-2.5 rounded-xl text-sm font-bold hover:bg-red-700 shadow-lg shadow-red-200", children: editingDriver ? "Mettre a jour" : "Creer le livreur" }), _jsx("button", { onClick: () => { setShowForm(false); setEditingDriver(null); }, className: "px-5 py-2.5 bg-gray-100 rounded-xl text-sm font-semibold text-gray-600", children: "Annuler" })] })] }) })), showAlarmModal && (_jsx("div", { className: "fixed inset-0 bg-black/50 flex items-center justify-center p-4", style: { zIndex: 9999 }, children: _jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-5 w-full max-w-md", style: { zIndex: 10000 }, children: [_jsxs("div", { className: "flex items-center gap-3 mb-4", children: [_jsx("div", { className: "w-10 h-10 bg-red-100 rounded-xl flex items-center justify-center", children: _jsx(Bell, { size: 18, className: "text-red-600" }) }), _jsxs("div", { children: [_jsx("h3", { className: "font-bold text-sm text-gray-900 dark:text-white", children: "Envoyer une alarme" }), _jsxs("p", { className: "text-[10px] text-gray-500 dark:text-gray-400", children: ["a ", showAlarmModal.name] })] })] }), _jsxs("select", { value: alarmReason, onChange: e => setAlarmReason(e.target.value), "data-testid": "alarm-reason-select", className: "w-full px-3 py-2.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-sm dark:text-white mb-2", children: [_jsx("option", { value: "", children: "Choisir un motif..." }), _jsx("option", { value: "Retard de livraison detecte - Accelerez votre course", children: "Retard de livraison" }), _jsx("option", { value: "Client en attente - Merci de vous depecher", children: "Client en attente" }), _jsx("option", { value: "Changement d'adresse de livraison - Verifiez vos commandes", children: "Changement d'adresse" }), _jsx("option", { value: "Contactez l'administration immediatement", children: "Contact urgent" }), _jsx("option", { value: "Votre position GPS n'est plus visible - Reactiver la localisation", children: "GPS perdu" })] }), _jsx("input", { type: "text", value: alarmReason, onChange: e => setAlarmReason(e.target.value), placeholder: "Ou tapez un message personnalise...", "data-testid": "alarm-reason-input", className: "w-full px-3 py-2.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-sm dark:text-white mb-4 focus:outline-none focus:ring-2 focus:ring-red-500" }), _jsxs("div", { className: "flex gap-2", children: [_jsxs("button", { onClick: () => sendAlarm(showAlarmModal.id), "data-testid": "button-send-alarm", className: "flex-1 bg-red-600 text-white py-3 rounded-xl font-bold text-sm hover:bg-red-700 shadow-lg shadow-red-200 flex items-center justify-center gap-2", children: [_jsx(Zap, { size: 14 }), " Envoyer l'alarme"] }), _jsx("button", { onClick: () => { setShowAlarmModal(null); setAlarmReason(""); }, className: "px-5 py-3 bg-gray-100 rounded-xl text-sm font-semibold text-gray-600", children: "Annuler" })] })] }) })), _jsxs("div", { className: "flex gap-3", style: { height: "calc(100vh - 340px)", minHeight: 400 }, children: [_jsx("div", { className: `${mobilePanel === "info" ? "flex" : "hidden"} lg:flex w-full lg:w-[280px] xl:w-[300px] shrink-0 flex-col bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden`, children: sd ? (_jsxs("div", { className: "flex-1 overflow-y-auto", children: [_jsxs("div", { className: "p-4 border-b border-gray-100 dark:border-gray-800", children: [_jsxs("button", { onClick: () => { setSelectedDriver(null); setMobilePanel("list"); }, className: "lg:hidden flex items-center gap-1 text-xs text-gray-500 mb-3 hover:text-gray-700", "data-testid": "back-to-list", children: [_jsx(ChevronLeft, { size: 14 }), " Retour a la liste"] }), _jsxs("div", { className: "flex items-center gap-3", children: [_jsxs("div", { className: "relative", children: [_jsx("div", { className: `w-14 h-14 rounded-2xl flex items-center justify-center ${getDriverStatus(sd) === "busy" ? "bg-orange-100" :
                                                ...
                                                return (_jsx("div", { onClick: () => selectDriver(d), "data-testid": `driver-card-${d.id}`, className: `px-3 py-2.5 border-b border-gray-50 cursor-pointer transition-all hover:bg-gray-50 ${isSelected ? "bg-red-50 border-l-[3px] border-l-red-600" : ""}`, children: _jsxs("div", { className: "flex items-center gap-2.5", children: [_jsxs("div", { className: "relative shrink-0", children: [_jsx("div", { className: `w-9 h-9 rounded-lg flex items-center justify-center ${status === "busy" ? "bg-orange-100" : status === "online" ? "bg-green-100" : status === "blocked" ? "bg-red-100" : "bg-gray-100"}`, children: _jsx(Truck, { size: 14, className: status === "busy" ? "text-orange-600" : status === "online" ? "text-green-600" : status === "blocked" ? "text-red-600" : "text-gray-400" }) }), _jsx("div", { className: `absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full border-[1.5px] border-white ${status === "busy" ? "bg-orange-500" : status === "online" ? "bg-green-500" : status === "blocked" ? "bg-red-500" : "bg-gray-400"}` })] }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsxs("div", { className: "flex items-center justify-between gap-1", children: [_jsx("p", { className: "font-bold text-xs text-gray-900 truncate", children: d.name }), _jsx("span", { className: `text-[7px] font-bold px-1.5 py-0.5 rounded-full shrink-0 ${status === "busy" ? "bg-orange-100 text-orange-700" :
                                                                                    status === "online" ? "bg-green-100 text-green-700" :
                                                                                        status === "blocked" ? "bg-red-100 text-red-700" :
                                                                                            "bg-gray-100 text-gray-500 dark:text-gray-400"}`, children: status === "busy" ? "OCCUPE" : status === "online" ? "DISPO" : status === "blocked" ? "BLOQUE" : "OFF" })] }), _jsxs("div", { className: "flex items-center gap-2 mt-0.5", children: [_jsx("span", { className: "text-[9px] text-gray-400 capitalize", children: d.vehicleType || "Moto" }), _jsx("span", { className: "text-[9px] text-gray-400", children: d.phone })] }), active.length > 0 && (_jsxs("div", { className: "flex items-center gap-1.5 mt-1", children: [_jsxs("span", { className: "text-[9px] text-orange-600 font-semibold", children: [active.length, " cmd"] }), active[0]?.estimatedDelivery && (_jsx(CountdownTimer, { estimatedDelivery: active[0].estimatedDelivery, compact: true }))] }))] })] }) }, d.id));
