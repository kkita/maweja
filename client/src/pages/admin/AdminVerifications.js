...
export default function AdminVerifications() {
    ...
    return (_jsxs(AdminLayout, { title: "Verifications livreurs", children: [previewImage && (_jsx("div", { className: "fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4", onClick: () => setPreviewImage(null), children: _jsx("img", { src: previewImage, alt: "Preview", className: "max-w-full max-h-full rounded-2xl object-contain" }) })), _jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6", children: [_jsx("div", { className: "bg-white rounded-xl p-4 border border-gray-100 dark:border-gray-800 shadow-sm", children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "w-10 h-10 bg-orange-50 rounded-xl flex items-center justify-center", children: _jsx(Clock, { size: 18, className: "text-orange-600" }) }), _jsxs("div", { children: [_jsx("p", { className: "text-2xl font-black text-gray-900 dark:text-white", children: pendingDrivers.filter(d => d.verificationStatus === "pending").length }), _jsx("p", { className: "text-[10px] text-gray-500 dark:text-gray-400", children: "En attente" })] })] }) }), _jsx("div", { className: "bg-white rounded-xl p-4 border border-gray-100 dark:border-gray-800 shadow-sm", children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "w-10 h-10 bg-red-50 rounded-xl flex items-center justify-center", children: _jsx(AlertCircle, { size: 18, className: "text-red-600" }) }), _jsxs("div", { children: [_jsx("p", { className: "text-2xl font-black text-gray-900 dark:text-white", children: pendingDrivers.filter(d => d.verificationStatus === "rejected").length }), _jsx("p", { className: "text-[10px] text-gray-500 dark:text-gray-400", children: "Rejetes" })] })] }) })] }), _jsxs("div", { className: "flex gap-4", style: { height: "calc(100vh - 240px)", minHeight: 400 }, children: [_jsxs("div", { className: "w-[320px] shrink-0 bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden flex flex-col", children: [_jsx("div", { className: "px-4 py-3 border-b border-gray-100 dark:border-gray-800", children: _jsxs("h3", { className: "font-bold text-sm text-gray-900 flex items-center gap-2", children: [_jsx(Shield, { size: 14, className: "text-red-600" }), " Demandes (", pendingDrivers.length, ")"] }) }), _jsx("div", { className: "flex-1 overflow-y-auto", children: pendingDrivers.length === 0 ? (_jsxs("div", { className: "text-center py-16 text-gray-400", children: [_jsx(CheckCircle2, { size: 36, className: "mx-auto mb-2 opacity-20" }), _jsx("p", { className: "text-xs font-medium", children: "Aucune demande en attente" })] })) : (pendingDrivers.map((d) => (_jsx("div", { onClick: () => { setSelected(d); setRejectedFields([]); }, "data-testid": `verification-card-${d.id}`, className: `p-3 border-b border-gray-50 cursor-pointer transition-all hover:bg-gray-50 ${selected?.id === d.id ? "bg-red-50 border-l-[3px] border-l-red-600" : ""}`, children: _jsxs("div", { className: "flex items-center gap-3", children: [d.profilePhotoUrl ? (_jsx("img", { src: resolveImg(d.profilePhotoUrl), alt: "", className: "w-10 h-10 rounded-xl object-cover" })) : (_jsx("div", { className: "w-10 h-10 rounded-xl bg-gray-100 flex items-center justify-center", children: _jsx(User, { size: 16, className: "text-gray-400" }) })), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("p", { className: "font-bold text-xs text-gray-900 truncate", children: d.name }), _jsx("p", { className: "text-[10px] text-gray-500 dark:text-gray-400", children: d.email }), _jsx("span", { className: `text-[8px] font-bold px-1.5 py-0.5 rounded-full mt-1 inline-block ${d.verificationStatus === "pending" ? "bg-orange-100 text-orange-700" : "bg-red-100 text-red-700"}`, children: d.verificationStatus === "pending" ? "EN ATTENTE" : "REJETE" })] }), _jsx(ChevronRight, { size: 14, className: "text-gray-300" })] }) }, d.id)))) })] }), _jsx("div", { className: "flex-1 bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden flex flex-col", children: selected ? (_jsxs("div", { className: "flex-1 overflow-y-auto", children: [_jsx("div", { className: "p-5 border-b border-gray-100 dark:border-gray-800", children: _jsxs("div", { className: "flex items-center gap-4", children: [selected.profilePhotoUrl ? (_jsx("img", { src: resolveImg(selected.profilePhotoUrl), alt: "", className: "w-16 h-16 rounded-2xl object-cover cursor-pointer hover:opacity-80", onClick: () => setPreviewImage(selected.profilePhotoUrl) })) : (_jsx("div", { className: "w-16 h-16 rounded-2xl bg-gray-100 flex items-center justify-center", children: _jsx(User, { size: 24, className: "text-gray-400" }) })), _jsxs("div", { children: [_jsx("h2", { className: "text-lg font-black text-gray-900 dark:text-white", "data-testid": "verification-driver-name", children: selected.name }), _jsxs("p", { className: "text-xs text-gray-500 dark:text-gray-400", children: [selected.email, " - ", selected.phone] }), _jsx("span", { className: `text-[9px] font-bold px-2 py-0.5 rounded-full mt-1 inline-block ${selected.verificationStatus === "pending" ? "bg-orange-100 text-orange-700" : "bg-red-100 text-red-700"}`, children: selected.verificationStatus === "pending" ? "EN ATTENTE DE VERIFICATION" : "CORRECTIONS DEMANDEES" })] })] }) }), _jsxs("div", { className: "p-5", children: [_jsx("p", { className: "text-[10px] text-gray-500 font-semibold mb-3", children: "INFORMATIONS SOUMISES \u2014 Cochez les champs incorrects pour demander une correction" }), _jsx("div", { className: "space-y-3", children: FIELDS.map(field => {
