      ...
      <div className="max-w-lg mx-auto px-4 py-4">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 border border-gray-100 dark:border-gray-800 shadow-sm">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">Livraisons terminees</p>
          </div>
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 border border-gray-100 dark:border-gray-800 shadow-sm">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">Moy. par livraison ($)</p>
          </div>
        </div>
