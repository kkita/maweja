        ...
        <div className="overflow-y-auto flex-1 space-y-4 pr-1">
          {[
            ...
            <div key={title}>
              ...
              <p className="text-xs text-gray-600 dark:text-gray-300 leading-relaxed">{body}</p>
            </div>
          ))}
        ...
        {sent ? (
          ...
          <>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700 rounded-2xl text-sm resize-none focus:outline-none focus:ring-2 focus:ring-red-500 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 mb-4"
            />
            <button
              onClick={send}
