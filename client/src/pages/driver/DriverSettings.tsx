        ...
        <button
          ...
          className={`flex-1 flex flex-col items-center gap-1.5 py-3 rounded-xl border-2 transition-all text-xs font-semibold ${
            theme === value
              ...
              : "bg-gray-50 border-transparent text-gray-600 hover:border-gray-200:border-gray-600"
          }`}
        >
          <Icon size={18} />
          {label}
      ...
      <div className="w-full max-w-lg bg-white rounded-t-3xl p-6 pb-10 animate-in slide-in-from-top" onClick={e => e.stopPropagation()}>
        ...
        {permission !== "granted" && (
          <div className="bg-red-50 border border-red-200 rounded-2xl p-4 mb-5">
            <p className="text-sm font-semibold text-red-700 mb-1">Notifications désactivées</p>
            <p className="text-xs text-red-600 mb-3">Activez pour recevoir les nouvelles commandes et alertes.</p>
            <button
        ...
        {permission === "granted" && (
          <div className="bg-green-50 border border-green-200 rounded-2xl p-4 mb-5 flex items-center gap-3">
            ...
            <p className="text-sm font-semibold text-green-700">Notifications activées</p>
          </div>
        )}
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={key} className="flex items-center justify-between bg-gray-50 rounded-2xl p-4">
              <div>
              ...
              <button
                ...
                className={`w-12 h-6 rounded-full transition-all relative ${val ? "bg-red-600" : "bg-gray-300"}`}
              >
      ...
      <div className="w-full max-w-lg bg-white rounded-t-3xl p-6 pb-10 max-h-[85vh] flex flex-col animate-in slide-in-from-top" onClick={e => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-black text-gray-900">Politique de Confidentialité</h3>
          </div>
          <button onClick={onClose} className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center">
            <X size={16} className="text-gray-500" />
          </button>
        ...
        <div className="overflow-y-auto flex-1 space-y-4 pr-1">
          ...
          <p className="text-[10px] text-gray-400 text-center mt-4">Dernière mise à jour : Mars 2026 — MAWEJA / Ed Corporation</p>
        </div>
      </div>
    </div>
  );
      ...
      <div className="w-full max-w-lg bg-white rounded-t-3xl p-6 pb-10 animate-in slide-in-from-top" onClick={e => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-black text-gray-900">Contacter le Support</h3>
          </div>
          <button onClick={onClose} className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center">
            <X size={16} className="text-gray-500" />
          </button>
        ...
        {sent ? (
          <div className="text-center py-8">
            ...
            <h4 className="text-lg font-black text-gray-900 mb-2">Message envoyé !</h4>
          ...
          <>
            ...
            <p className="text-sm font-semibold text-gray-700 mb-3">Votre message :</p>
            <textarea
              value={message}
              ...
              rows={4}
              className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-2xl text-sm resize-none focus:outline-none focus:ring-2 focus:ring-red-500 text-gray-900 placeholder-gray-400 mb-4"
            />
            <button
              onClick={send}
      ...
      <div className="w-full max-w-lg bg-white rounded-t-3xl p-6 pb-10 animate-in slide-in-from-top" onClick={e => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-black text-gray-900">À propos</h3>
          </div>
          <button onClick={onClose} className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center">
            <X size={16} className="text-gray-500" />
          </button>
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-black text-gray-900">MAWEJA Driver</h2>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-4">
          ...
          <div className="p-4 space-y-2">
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${lang === "fr" ? "bg-red-50 border-2 border-red-500" : "bg-gray-50 border-2 border-transparent hover:border-gray-200:border-gray-600"}`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${lang === "en" ? "bg-red-50 border-2 border-red-500" : "bg-gray-50 border-2 border-transparent hover:border-gray-200:border-gray-600"}`}
            >
              <span className="text-xl">🇬🇧</span>
          ...
          <div className="divide-y divide-gray-50">
            {[
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-5 py-4 hover:bg-gray-50:bg-gray-800 transition-colors"
              >
