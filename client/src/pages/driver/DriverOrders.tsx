  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-2 mb-3">
        ...
        <p className="text-xs text-gray-600 dark:text-gray-400 line-clamp-2">{order.deliveryAddress}</p>
      </div>
      ...
      <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-gray-700/50">
        ...
        <div className="text-right">
          ...
          <p className="text-sm font-bold text-gray-700 dark:text-gray-300">{order.items?.length || 0} article{(order.items?.length || 0) > 1 ? "s" : ""}</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pb-28">
      ...
      <div className="max-w-lg mx-auto px-4 py-5">
        <div className="flex items-center justify-between mb-5">
          ...
          <button
            onClick={() => refetch()}
            className="w-9 h-9 flex items-center justify-center rounded-xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 text-gray-400 hover:text-gray-600 active:scale-90 transition-all shadow-sm"
