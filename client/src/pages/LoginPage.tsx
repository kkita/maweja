    ...
    <div className="min-h-screen bg-gradient-to-br from-red-600 via-red-700 to-red-900 flex">
      <div className="hidden lg:flex flex-1 items-center justify-center p-12">
        <div className="max-w-md">
          <div className="w-20 h-20 rounded-3xl mb-8 bg-white/20 shadow-2xl shadow-red-900/50 flex items-center justify-center overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          <div className="text-center mb-8 lg:hidden">
            <div className="w-20 h-20 rounded-3xl mx-auto mb-4 bg-white/20 shadow-2xl shadow-red-900/30 flex items-center justify-center overflow-hidden">
              <img src={logoImg} alt="Maweja" className="w-full h-full object-contain p-1" />
            </div>
            <h1
