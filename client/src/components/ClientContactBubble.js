...
export default function ClientContactBubble() {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("button", { onClick: () => { setIsOpen(!isOpen); if (!isOpen) {
                    ...
                    setSelectedAdmin(null);
                } }, "data-testid": "button-contact-bubble", className: "fixed bottom-[88px] right-4 z-50 w-14 h-14 bg-red-600 text-white rounded-full flex items-center justify-center shadow-xl shadow-red-300 hover:bg-red-700 transition-all hover:scale-110", children: [isOpen ? _jsx(X, { size: 22 }) : _jsx(MessageCircle, { size: 22 }), !isOpen && totalUnread > 0 && (_jsx("span", { className: "absolute -top-1 -right-1 bg-white dark:bg-gray-900 text-red-600 text-[9px] font-black w-5 h-5 rounded-full flex items-center justify-center border-2 border-red-600", "data-testid": "unread-bubble-count", children: totalUnread }))] }), isOpen && (_jsxs("div", { className: "fixed bottom-40 right-4 z-50 w-80 bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden", style: { maxHeight: "480px" }, "data-testid": "contact-panel", children: [view === "menu" && (_jsxs(_Fragment, { children: [_jsxs("div", { className: "bg-red-600 p-4", children: [_jsx("h3", { className: "text-white font-bold text-sm", children: "Contactez-nous" }), _jsx("p", { className: "text-red-200 text-xs mt-0.5", children: "Comment pouvons-nous vous aider ?" })] }), _jsxs("div", { className: "p-3 space-y-2", children: [user ? (_jsxs("button", { onClick: () => {
                                            const admin = admins.find((a) => a.isOnline) || admins[0];
                                            if (admin) {
                                        ...
                                        }, "data-testid": "button-start-chat", className: "w-full bg-gray-50 dark:bg-gray-800 rounded-xl p-3 flex items-center gap-3 hover:bg-gray-100 dark:bg-gray-800 transition-all text-left border border-gray-100 dark:border-gray-800", children: [_jsx("div", { className: "w-10 h-10 bg-blue-50 rounded-xl flex items-center justify-center", children: _jsx(MessageCircle, { size: 18, className: "text-blue-600" }) }), _jsxs("div", { className: "flex-1", children: [_jsx("p", { className: "font-semibold text-sm text-gray-900 dark:text-white", children: "Chat en direct" }), _jsx("p", { className: "text-[10px] text-gray-400 dark:text-gray-500", children: "Discutez avec un administrateur" })] }), totalUnread > 0 && (_jsx("span", { className: "bg-red-600 text-white text-[9px] font-bold w-5 h-5 rounded-full flex items-center justify-center", children: totalUnread }))] })) : null, _jsxs("button", { onClick: () => window.open(`https://wa.me/${whatsappNumber}?text=Bonjour MAWEJA, j'ai besoin d'aide.`, "_blank"), "data-testid": "button-whatsapp", className: "w-full bg-gray-50 dark:bg-gray-800 rounded-xl p-3 flex items-center gap-3 hover:bg-gray-100 dark:bg-gray-800 transition-all text-left border border-gray-100 dark:border-gray-800", children: [_jsx("div", { className: "w-10 h-10 bg-green-50 rounded-xl flex items-center justify-center", children: _jsx(SiWhatsapp, { size: 18, className: "text-green-600" }) }), _jsxs("div", { children: [_jsx("p", { className: "font-semibold text-sm text-gray-900 dark:text-white", children: "WhatsApp" }), _jsx("p", { className: "text-[10px] text-gray-400 dark:text-gray-500", children: "Ecrivez-nous sur WhatsApp" })] })] }), user && (_jsxs("button", { onClick: () => { setView("complaint"); setComplaintSent(false); }, "data-testid": "button-start-complaint", className: "w-full bg-gray-50 dark:bg-gray-800 rounded-xl p-3 flex items-center gap-3 hover:bg-gray-100 dark:bg-gray-800 transition-all text-left border border-gray-100 dark:border-gray-800", children: [_jsx("div", { className: "w-10 h-10 bg-orange-50 rounded-xl flex items-center justify-center", children: _jsx(AlertTriangle, { size: 18, className: "text-orange-600" }) }), _jsxs("div", { children: [_jsx("p", { className: "font-semibold text-sm text-gray-900 dark:text-white", children: "Reclamation" }), _jsx("p", { className: "text-[10px] text-gray-400 dark:text-gray-500", children: "Signalez un probleme structure" })] })] }))] })] })), view === "chat" && selectedAdmin && (_jsxs("div", { className: "flex flex-col", style: { height: "480px" }, children: [_jsxs("div", { className: "bg-red-600 p-3 flex items-center gap-3", children: [_jsx("button", { onClick: () => { setView("menu"); setSelectedAdmin(null); }, className: "text-white/80 hover:text-white", children: _jsx(ArrowLeft, { size: 18 }) }), _jsxs("div", { className: "relative", children: [_jsx("div", { className: "w-8 h-8 bg-white dark:bg-gray-900/20 rounded-lg flex items-center justify-center", children: _jsx(Shield, { size: 14, className: "text-white" }) }), selectedAdmin.isOnline && (_jsx(Circle, { size: 8, className: "absolute -bottom-0.5 -right-0.5 text-green-400 fill-green-400" }))] }), _jsxs("div", { children: [_jsx("p", { className: "text-white font-bold text-xs", children: selectedAdmin.name }), _jsx("p", { className: "text-red-200 text-[10px]", children: selectedAdmin.isOnline ? "En ligne" : "Hors ligne" })] })] }), _jsxs("div", { className: "flex-1 overflow-y-auto p-3 space-y-2 bg-gray-50 dark:bg-gray-800", children: [messages.length === 0 && (_jsxs("div", { className: "text-center pt-12 text-gray-400 dark:text-gray-500", children: [_jsx(MessageCircle, { size: 28, className: "mx-auto mb-2 opacity-30" }), _jsx("p", { className: "text-xs", children: "Envoyez votre premier message" })] })), messages.map((msg) => (_jsx("div", { className: `flex ${msg.senderId === user?.id ? "justify-end" : "justify-start"}`, children: _jsxs("div", { className: `max-w-[80%] px-3 py-2 rounded-xl text-xs ${msg.senderId === user?.id
                                                ? "bg-red-600 text-white rounded-br-sm"
                                                : "bg-white dark:bg-gray-900 text-gray-900 dark:text-white rounded-bl-sm shadow-sm border border-gray-100 dark:border-gray-800"}`, children: [_jsx("p", { children: msg.message }), _jsx("p", { className: `text-[8px] mt-0.5 ${msg.senderId === user?.id ? "text-red-200" : "text-gray-400 dark:text-gray-500"}`, children: formatTime(msg.createdAt) })] }) }, msg.id))), _jsx("div", { ref: messagesEnd })] }), _jsx("div", { className: "p-2 border-t border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900", children: _jsxs("div", { className: "flex gap-1.5", children: [_jsx("input", { type: "text", value: message, onChange: (e) => setMessage(e.target.value), onKeyDown: (e) => e.key === "Enter" && sendMessage(), placeholder: "Votre message...", "data-testid": "client-chat-input", className: "flex-1 px-3 py-2.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-red-500" }), _jsx("button", { onClick: sendMessage, "data-testid": "client-chat-send", className: "w-10 h-10 bg-red-600 text-white rounded-lg flex items-center justify-center hover:bg-red-700", children: _jsx(Send, { size: 14 }) })] }) })] })), view === "complaint" && (_jsxs(_Fragment, { children: [_jsxs("div", { className: "bg-red-600 p-3 flex items-center gap-3", children: [_jsx("button", { onClick: () => setView("menu"), className: "text-white/80 hover:text-white", children: _jsx(ArrowLeft, { size: 18 }) }), _jsx("div", { className: "w-8 h-8 bg-white dark:bg-gray-900/20 rounded-lg flex items-center justify-center", children: _jsx(AlertTriangle, { size: 14, className: "text-white" }) }), _jsxs("div", { children: [_jsx("p", { className: "text-white font-bold text-xs", children: "Reclamation" }), _jsx("p", { className: "text-red-200 text-[10px]", children: "Signalez un probleme" })] })] }), complaintSent ? (_jsxs("div", { className: "p-8 text-center", children: [_jsx("div", { className: "w-16 h-16 bg-green-50 rounded-full flex items-center justify-center mx-auto mb-4", children: _jsx(CheckCircle2, { size: 28, className: "text-green-600" }) }), _jsx("h4", { className: "font-bold text-sm text-gray-900 dark:text-white mb-1", children: "Reclamation envoyee" }), _jsx("p", { className: "text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500", children: "Un administrateur vous repondra dans les plus brefs delais." })] })) : (_jsxs("div", { className: "p-3 space-y-3", children: [_jsxs("div", { children: [_jsx("label", { className: "text-[10px] font-semibold text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase mb-1 block", children: "Sujet" }), _jsxs("select", { value: complaintSubject, onChange: e => setComplaintSubject(e.target.value), "data-testid": "complaint-subject", className: "w-full px-3 py-2.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-red-500", children: [_jsx("option", { value: "", children: "Choisir un sujet..." }), _jsx("option", { value: "Commande non livree", children: "Commande non livree" }), _jsx("option", { value: "Retard de livraison", children: "Retard de livraison" }), _jsx("option", { value: "Commande incorrecte", children: "Commande incorrecte" }), _jsx("option", { value: "Qualite de nourriture", children: "Qualite de nourriture" }), _jsx("option", { value: "Probleme de paiement", children: "Probleme de paiement" }), _jsx("option", { value: "Comportement du livreur", children: "Comportement du livreur" }), _jsx("option", { value: "Probleme technique", children: "Probleme technique" }), _jsx("option", { value: "Autre", children: "Autre" })] })] }), _jsxs("div", { children: [_jsx("label", { className: "text-[10px] font-semibold text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase mb-1 block", children: "Description detaillee" }), _jsx("textarea", { value: complaintMessage, onChange: e => setComplaintMessage(e.target.value), placeholder: "Decrivez votre probleme en detail...", "data-testid": "complaint-message", className: "w-full px-3 py-2.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-xs resize-none h-28 focus:outline-none focus:ring-2 focus:ring-red-500" })] }), _jsxs("button", { onClick: sendComplaint, disabled: !complaintSubject || !complaintMessage.trim(), "data-testid": "button-send-complaint", className: "w-full bg-red-600 text-white py-3 rounded-xl text-xs font-bold hover:bg-red-700 disabled:opacity-50 shadow-lg shadow-red-200 flex items-center justify-center gap-2", children: [_jsx(Send, { size: 14 }), "Envoyer la reclamation"] })] }))] }))] }))] }));
}
