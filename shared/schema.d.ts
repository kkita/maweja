...
export declare const restaurants: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        restaurantCommissionRate: import("drizzle-orm/pg-core").PgColumn<{
            name: "restaurant_commission_rate";
            tableName: "restaurants";
            dataType: "number";
            columnType: "PgInteger";
            data: number;
...
export declare const restaurantPayouts: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "restaurant_payouts";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "restaurant_payouts";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
        ...
        restaurantName: import("drizzle-orm/pg-core").PgColumn<{
        ...
        mawejaCommission: import("drizzle-orm/pg-core").PgColumn<{
            name: "maweja_commission";
            tableName: "restaurant_payouts";
            dataType: "number";
            columnType: "PgInteger";
            data: number;
...
export declare const orders: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        orderPhone: import("drizzle-orm/pg-core").PgColumn<{
            name: "order_phone";
            tableName: "orders";
            dataType: "string";
            columnType: "PgText";
...
export declare const promoBanners: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "promo_banners";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
        ...
        tagText: import("drizzle-orm/pg-core").PgColumn<{
            name: "tag_text";
            tableName: "promo_banners";
            dataType: "string";
            columnType: "PgText";
        ...
        bgColorFrom: import("drizzle-orm/pg-core").PgColumn<{
            name: "bg_color_from";
            tableName: "promo_banners";
            dataType: "string";
            columnType: "PgText";
        ...
        bgColorTo: import("drizzle-orm/pg-core").PgColumn<{
            name: "bg_color_to";
            tableName: "promo_banners";
            dataType: "string";
            columnType: "PgText";
...
}, "id" | "createdAt" | "usedCount">, "strip", z.ZodTypeAny, {
    description: string;
    code: string;
...
export declare const insertServiceCategorySchema: z.ZodObject<Omit<{
    ...
    serviceTypes: z.ZodOptional<z.ZodNullable<z.ZodArray<z.ZodString, "many">>>;
    createdAt: z.ZodOptional<z.ZodNullable<z.ZodDate>>;
...
export declare const insertUserSchema: z.ZodObject<Omit<{
    ...
    adminRole: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    adminPermissions: z.ZodOptional<z.ZodNullable<z.ZodType<import("node_modules/drizzle-zod/utils.mjs").Json, z.ZodTypeDef, import("node_modules/drizzle-zod/utils.mjs").Json>>>;
    ...
    adminPermissions?: import("node_modules/drizzle-zod/utils.mjs").Json | undefined;
...
export declare const insertRestaurantSchema: z.ZodObject<Omit<{
    ...
    restaurantCommissionRate: z.ZodOptional<z.ZodNumber>;
    discountPercent: z.ZodOptional<z.ZodNumber>;
    sortOrder: z.ZodOptional<z.ZodNumber>;
    discountLabel: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    ...
    restaurantCommissionRate?: number | undefined;
...
export declare const insertOrderSchema: z.ZodObject<Omit<{
    ...
    orderPhone: z.ZodOptional<z.ZodNullable<z.ZodString>>;
...
export declare const insertPromoBannerSchema: z.ZodObject<Omit<{
    id: z.ZodOptional<z.ZodNumber>;
    ...
    linkUrl: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    bgColorFrom: z.ZodOptional<z.ZodString>;
    bgColorTo: z.ZodOptional<z.ZodString>;
    isActive: z.ZodOptional<z.ZodBoolean>;
    updatedAt: z.ZodOptional<z.ZodNullable<z.ZodDate>>;
    ...
    bgColorFrom?: string | undefined;
    bgColorTo?: string | undefined;
}, {
    isActive?: boolean | undefined;
    title?: string | undefined;
    linkUrl?: string | null | undefined;
...
export declare const insertRestaurantPayoutSchema: z.ZodObject<Omit<{
    id: z.ZodOptional<z.ZodNumber>;
    restaurantId: z.ZodNumber;
    ...
    mawejaCommission: z.ZodOptional<z.ZodNumber>;
    ...
    mawejaCommission?: number | undefined;
...
export declare const restaurantCategories: import("drizzle-orm/pg-core").PgTableWithColumns<{
...
export declare const insertRestaurantCategorySchema: z.ZodObject<Omit<{
    id: z.ZodOptional<z.ZodNumber>;
    name: z.ZodString;
